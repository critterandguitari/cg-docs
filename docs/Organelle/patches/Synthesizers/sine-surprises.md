...
<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/242845143&color=%23ff5500"></iframe>

**Tags:** Synthesizer, Sequencer

**[Download Patch](https://patchstorage.com/wp-content/uploads/2021/04/Sine-Surprises.zip)**

Polyphonic, sine wave version of 'Nice Surprises.' Three oscillators combine to increase levels of (dis)harmony. One oscillator produces 'junk'/random frequencies that adds nice surprises.

## Details

The same synth as Nice Surprises but with four-voice polyphony. Control three sine wave oscillators with this patch. Keyboard controls the base frequency of one oscillator, also tunable with knob 2. The second oscillator plays a selectable harmonic above the base frequency. The third oscillator plays a adjustable amount of random junk frequencies at the beginning of each note.   Set the amount of 'Slidiness' as oscillators glide to their next frequency. Aux button controls a sequencer: hold it down to enable recording, begin playing to start a recording, and press Aux again to finish.
...
4. Overdub the sequence, etc.  
5. Revisit the above steps in any order as needed.

To do step 2, you will need to use knobs:  
Knob1: Harmonic Selector  
Knob2: Base Frequency  
Knob3: 'Junk' length  
Knob4: 'Slidiness' (Glide Amount)
