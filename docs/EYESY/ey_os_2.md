...
1. Download the microSD card disk image to your computer: 
    ...
    - New OS release version 3.1 (see OS v3 manual after flashing): [EYESY-3.1](https://cgdiskimages.nyc3.digitaloceanspaces.com/EYESY_v3.1.img.zip). Requires 8GB or larger microSD card.
